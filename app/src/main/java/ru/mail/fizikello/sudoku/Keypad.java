...
//Метод isValid() проверяет, является ли заданная цифра подходящей для текущей
//позиции. Если цифра находится в массиве useds, значит, она не подходит, так как она уже
//использована в текущей строке, столбце или блоке.
...
//Метод returnResult() вызывается для возврата цифры, выбранной в вызванной
//деятельности:
    private void returnResult(int tile){
        puzzleView.setSelectedTitle(tile);
        dismiss();
    }
